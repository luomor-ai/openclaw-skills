...
SENSITIVE_KEYWORDS = {
    "Contract/Agreement": ["合同", "协议", "Contract", "Agreement"],
    "Transaction Data": ["交易记录", "支付明细", "Transaction Data", "Amount", "Balance"],
    "Personal Privacy": ["身份证", "手机号", "家庭住址", "Personal Privacy", "ID Card", "Phone Number"],
    "Customer Privacy": ["客户信息", "Client Data", "Customer Privacy", "User Profile"]
}
