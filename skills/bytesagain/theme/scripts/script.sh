#!/usr/bin/env bash
# theme — Theme reference tool. Use when working with theme in devtools contexts.
...
show_help() {
    cat << 'HELPEOF'
theme v$VERSION — Theme Reference Tool
...
## What is Theme?
Theme (theme) is a specialized tool/concept in the devtools domain.
It provides essential capabilities for professionals working with theme.

## Key Concepts
- Core theme principles and fundamentals
- How theme fits into the broader devtools ecosystem  
- Essential terminology every practitioner should know

## Why Theme Matters
Understanding theme is critical for:
...
## Getting Started
1. Understand the basic theme concepts
...
## Installation
1. Download or clone the theme package
...
cmd_patterns() {
    cat << 'EOF'
# Theme — Common Patterns & Best Practices

## Design Patterns
1. **Standard Pattern**: The most common approach for theme
