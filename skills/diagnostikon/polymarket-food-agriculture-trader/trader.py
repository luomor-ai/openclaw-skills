...
Trades food and agriculture prediction markets: crop yields, commodity prices, food inflation, alternative protein, and supply shocks.
...
KEYWORDS = ['wheat', 'corn', 'soybean', 'coffee', 'cocoa', 'sugar', 'food price', 'crop yield', 'drought', 'harvest', 'USDA', 'FAO', 'food inflation', 'famine', 'supply shock', 'alternative protein', 'Beyond Meat', 'Impossible Foods', 'lab-grown', 'vertical farming', 'fertilizer', 'potash', 'nitrogen', 'pesticide', 'irrigation', 'El Niño crop', 'La Niña harvest', 'commodity']
...
MIN_DAYS       = int(os.environ.get(  "SIMMER_MIN_DAYS",      "10"))
