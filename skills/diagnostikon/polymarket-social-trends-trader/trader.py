...
KEYWORDS = ['mental health', 'suicide rate', 'drug legalization', 'cannabis', 'psychedelics', 'loneliness', 'social media ban', 'teen smartphone', 'TikTok ban', 'gun control', 'marijuana', 'psilocybin', 'FDA mental health', 'universal basic income', 'UBI', 'poverty rate', 'homelessness']
...
def run(live: bool = False) -> None:
    ...
    print(f"[polymarket-social-trends-trader] mode={mode} max_pos=${MAX_POSITION} min_vol=${MIN_VOLUME} max_spread={MAX_SPREAD:.0%} min_days={MIN_DAYS}")
